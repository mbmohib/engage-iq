...
function extractAuthorInfo(postElement: Element): {
  name: string;
  designation: string;
} {
...
function extractMetadata(postElement: Element): {
  likes: number;
  comments: number;
  shares: number;
} {
  const socialCountsBar = postElement.querySelector(
  ...
  if (socialCountsBar) {
    const reactionCount = socialCountsBar.querySelector(
    ...
    const commentCount = socialCountsBar.querySelector(
    ...
    const shareCount = socialCountsBar.querySelector(
