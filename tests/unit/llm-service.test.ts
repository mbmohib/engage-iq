...
Bold comment`;
  ...
  describe("callOpenAI", () => {
    ...
    it("should throw error if API key is missing", async () => {
      ...
      await expect(service.callOpenAI(postData, {})).rejects.toThrow(
  ...
  describe("callAnthropic", () => {
    ...
    it("should throw error if API key is missing", async () => {
      ...
      await expect(service.callAnthropic(postData, {})).rejects.toThrow(
  ...
  describe("generateComments", () => {
    ...
    it("should throw error for invalid tier", async () => {
      ...
      await expect(service.generateComments(postData)).rejects.toThrow(
